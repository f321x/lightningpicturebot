...
start_nostr = "Welcome to the Lightningpicturebot! This bot can generate images from prompts with DALLE2 and Stable Diffusion text-to-image AI. To get started just type in your prompt with /p. For example: /p yellow duck with sunglasses."